...
// @ts-nocheck 
/*
 * This file exports the `AboutUsPageId` model and its related types.
 *
...
export type GetAboutUsPageIdAggregateType<T extends AboutUsPageIdAggregateArgs> = {
      [P in keyof T & keyof AggregateAboutUsPageId]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAboutUsPageId[P]>
    : Prisma.GetScalarType<T[P], AggregateAboutUsPageId[P]>
}
...
type GetAboutUsPageIdGroupByPayload<T extends AboutUsPageIdGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<AboutUsPageIdGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof AboutUsPageIdGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], AboutUsPageIdGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], AboutUsPageIdGroupByOutputType[P]>
      }
    >
  >
...
export type AboutUsPageIdCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<AboutUsPageIdFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AboutUsPageIdDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['AboutUsPageId'], meta: { name: 'AboutUsPageId' } }
  /**
   ...
   * })
  **/
  count<T extends AboutUsPageIdCountArgs>(
    args?: Prisma.Subset<T, AboutUsPageIdCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], AboutUsPageIdCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends AboutUsPageIdGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, AboutUsPageIdGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAboutUsPageIdGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
