...
// @ts-nocheck 
/*
 * This file exports the `InvestorPageEn` model and its related types.
 *
...
export type GetInvestorPageEnAggregateType<T extends InvestorPageEnAggregateArgs> = {
      [P in keyof T & keyof AggregateInvestorPageEn]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateInvestorPageEn[P]>
    : Prisma.GetScalarType<T[P], AggregateInvestorPageEn[P]>
}
...
type GetInvestorPageEnGroupByPayload<T extends InvestorPageEnGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<InvestorPageEnGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof InvestorPageEnGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], InvestorPageEnGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], InvestorPageEnGroupByOutputType[P]>
      }
    >
  >
...
export type InvestorPageEnCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<InvestorPageEnFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface InvestorPageEnDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['InvestorPageEn'], meta: { name: 'InvestorPageEn' } }
  /**
   ...
   * })
  **/
  count<T extends InvestorPageEnCountArgs>(
    args?: Prisma.Subset<T, InvestorPageEnCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], InvestorPageEnCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends InvestorPageEnGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, InvestorPageEnGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetInvestorPageEnGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
