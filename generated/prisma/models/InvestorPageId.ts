...
// @ts-nocheck 
/*
 * This file exports the `InvestorPageId` model and its related types.
 *
...
export type GetInvestorPageIdAggregateType<T extends InvestorPageIdAggregateArgs> = {
      [P in keyof T & keyof AggregateInvestorPageId]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateInvestorPageId[P]>
    : Prisma.GetScalarType<T[P], AggregateInvestorPageId[P]>
}
...
type GetInvestorPageIdGroupByPayload<T extends InvestorPageIdGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<InvestorPageIdGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof InvestorPageIdGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], InvestorPageIdGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], InvestorPageIdGroupByOutputType[P]>
      }
    >
  >
...
export type InvestorPageIdCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<InvestorPageIdFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface InvestorPageIdDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['InvestorPageId'], meta: { name: 'InvestorPageId' } }
  /**
   ...
   * })
  **/
  count<T extends InvestorPageIdCountArgs>(
    args?: Prisma.Subset<T, InvestorPageIdCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], InvestorPageIdCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends InvestorPageIdGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, InvestorPageIdGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetInvestorPageIdGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
