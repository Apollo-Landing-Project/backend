...
// @ts-nocheck 
/*
 * This file exports the `CarGallery` model and its related types.
 *
...
export type GetCarGalleryAggregateType<T extends CarGalleryAggregateArgs> = {
      [P in keyof T & keyof AggregateCarGallery]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCarGallery[P]>
    : Prisma.GetScalarType<T[P], AggregateCarGallery[P]>
}
...
type GetCarGalleryGroupByPayload<T extends CarGalleryGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CarGalleryGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CarGalleryGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CarGalleryGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CarGalleryGroupByOutputType[P]>
      }
    >
  >
...
export type CarGalleryCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CarGalleryFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CarGalleryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CarGallery'], meta: { name: 'CarGallery' } }
  /**
   ...
   * })
  **/
  count<T extends CarGalleryCountArgs>(
    args?: Prisma.Subset<T, CarGalleryCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CarGalleryCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CarGalleryGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CarGalleryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCarGalleryGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
