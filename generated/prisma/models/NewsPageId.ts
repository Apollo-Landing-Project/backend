...
// @ts-nocheck 
/*
 * This file exports the `NewsPageId` model and its related types.
 *
...
export type GetNewsPageIdAggregateType<T extends NewsPageIdAggregateArgs> = {
      [P in keyof T & keyof AggregateNewsPageId]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNewsPageId[P]>
    : Prisma.GetScalarType<T[P], AggregateNewsPageId[P]>
}
...
type GetNewsPageIdGroupByPayload<T extends NewsPageIdGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<NewsPageIdGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof NewsPageIdGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], NewsPageIdGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], NewsPageIdGroupByOutputType[P]>
      }
    >
  >
...
export type NewsPageIdCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<NewsPageIdFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NewsPageIdDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['NewsPageId'], meta: { name: 'NewsPageId' } }
  /**
   ...
   * })
  **/
  count<T extends NewsPageIdCountArgs>(
    args?: Prisma.Subset<T, NewsPageIdCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], NewsPageIdCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends NewsPageIdGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, NewsPageIdGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNewsPageIdGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
