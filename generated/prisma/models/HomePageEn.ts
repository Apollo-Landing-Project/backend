...
// @ts-nocheck 
/*
 * This file exports the `HomePageEn` model and its related types.
 *
...
export type GetHomePageEnAggregateType<T extends HomePageEnAggregateArgs> = {
      [P in keyof T & keyof AggregateHomePageEn]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateHomePageEn[P]>
    : Prisma.GetScalarType<T[P], AggregateHomePageEn[P]>
}
...
type GetHomePageEnGroupByPayload<T extends HomePageEnGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<HomePageEnGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof HomePageEnGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], HomePageEnGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], HomePageEnGroupByOutputType[P]>
      }
    >
  >
...
export type HomePageEnCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<HomePageEnFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface HomePageEnDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['HomePageEn'], meta: { name: 'HomePageEn' } }
  /**
   ...
   * })
  **/
  count<T extends HomePageEnCountArgs>(
    args?: Prisma.Subset<T, HomePageEnCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], HomePageEnCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends HomePageEnGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, HomePageEnGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetHomePageEnGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
