...
// @ts-nocheck 
/*
 * This file exports the `ServicePage` model and its related types.
 *
...
export type GetServicePageAggregateType<T extends ServicePageAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateServicePage[P]>
    : Prisma.GetScalarType<T[P], AggregateServicePage[P]>
}
...
type GetServicePageGroupByPayload<T extends ServicePageGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ServicePageGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ServicePageGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ServicePageGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ServicePageGroupByOutputType[P]>
      }
    >
  >
...
export type ServicePageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ServicePageFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ServicePageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends ServicePageCountArgs>(
    args?: Prisma.Subset<T, ServicePageCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ServicePageCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ServicePageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetServicePageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
