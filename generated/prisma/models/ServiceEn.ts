...
// @ts-nocheck 
/*
 * This file exports the `ServiceEn` model and its related types.
 *
...
export type GetServiceEnAggregateType<T extends ServiceEnAggregateArgs> = {
      [P in keyof T & keyof AggregateServiceEn]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateServiceEn[P]>
    : Prisma.GetScalarType<T[P], AggregateServiceEn[P]>
}
...
type GetServiceEnGroupByPayload<T extends ServiceEnGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ServiceEnGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ServiceEnGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ServiceEnGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ServiceEnGroupByOutputType[P]>
      }
    >
  >
...
export type ServiceEnCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ServiceEnFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ServiceEnDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ServiceEn'], meta: { name: 'ServiceEn' } }
  /**
   ...
   * })
  **/
  count<T extends ServiceEnCountArgs>(
    args?: Prisma.Subset<T, ServiceEnCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ServiceEnCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ServiceEnGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ServiceEnGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetServiceEnGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
