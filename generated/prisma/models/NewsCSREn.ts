...
// @ts-nocheck 
/*
 * This file exports the `NewsCSREn` model and its related types.
 *
...
export type GetNewsCSREnAggregateType<T extends NewsCSREnAggregateArgs> = {
      [P in keyof T & keyof AggregateNewsCSREn]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNewsCSREn[P]>
    : Prisma.GetScalarType<T[P], AggregateNewsCSREn[P]>
}
...
type GetNewsCSREnGroupByPayload<T extends NewsCSREnGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<NewsCSREnGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof NewsCSREnGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], NewsCSREnGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], NewsCSREnGroupByOutputType[P]>
      }
    >
  >
...
export type NewsCSREnCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<NewsCSREnFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NewsCSREnDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['NewsCSREn'], meta: { name: 'NewsCSREn' } }
  /**
   ...
   * })
  **/
  count<T extends NewsCSREnCountArgs>(
    args?: Prisma.Subset<T, NewsCSREnCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], NewsCSREnCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends NewsCSREnGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, NewsCSREnGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNewsCSREnGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
