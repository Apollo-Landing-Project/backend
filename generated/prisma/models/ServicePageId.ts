...
// @ts-nocheck 
/*
 * This file exports the `ServicePageId` model and its related types.
 *
...
export type GetServicePageIdAggregateType<T extends ServicePageIdAggregateArgs> = {
      [P in keyof T & keyof AggregateServicePageId]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateServicePageId[P]>
    : Prisma.GetScalarType<T[P], AggregateServicePageId[P]>
}
...
type GetServicePageIdGroupByPayload<T extends ServicePageIdGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ServicePageIdGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ServicePageIdGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ServicePageIdGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ServicePageIdGroupByOutputType[P]>
      }
    >
  >
...
export type ServicePageIdCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ServicePageIdFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ServicePageIdDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ServicePageId'], meta: { name: 'ServicePageId' } }
  /**
   ...
   * })
  **/
  count<T extends ServicePageIdCountArgs>(
    args?: Prisma.Subset<T, ServicePageIdCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ServicePageIdCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ServicePageIdGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ServicePageIdGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetServicePageIdGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
