...
// @ts-nocheck 
/*
 * This file exports the `InvestorPage` model and its related types.
 *
...
export type GetInvestorPageAggregateType<T extends InvestorPageAggregateArgs> = {
      [P in keyof T & keyof AggregateInvestorPage]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateInvestorPage[P]>
    : Prisma.GetScalarType<T[P], AggregateInvestorPage[P]>
}
...
type GetInvestorPageGroupByPayload<T extends InvestorPageGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<InvestorPageGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof InvestorPageGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], InvestorPageGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], InvestorPageGroupByOutputType[P]>
      }
    >
  >
...
export type InvestorPageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<InvestorPageFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface InvestorPageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['InvestorPage'], meta: { name: 'InvestorPage' } }
  /**
   ...
   * })
  **/
  count<T extends InvestorPageCountArgs>(
    args?: Prisma.Subset<T, InvestorPageCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], InvestorPageCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends InvestorPageGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, InvestorPageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetInvestorPageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
