...
// @ts-nocheck 
/*
 * This file exports the `NewsCSR` model and its related types.
 *
...
export type GetNewsCSRAggregateType<T extends NewsCSRAggregateArgs> = {
      [P in keyof T & keyof AggregateNewsCSR]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNewsCSR[P]>
    : Prisma.GetScalarType<T[P], AggregateNewsCSR[P]>
}
...
type GetNewsCSRGroupByPayload<T extends NewsCSRGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<NewsCSRGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof NewsCSRGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], NewsCSRGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], NewsCSRGroupByOutputType[P]>
      }
    >
  >
...
export type NewsCSRCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<NewsCSRFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NewsCSRDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['NewsCSR'], meta: { name: 'NewsCSR' } }
  /**
   ...
   * })
  **/
  count<T extends NewsCSRCountArgs>(
    args?: Prisma.Subset<T, NewsCSRCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], NewsCSRCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, NewsCSRGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNewsCSRGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
