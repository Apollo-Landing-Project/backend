...
export type GetGovernanceAggregateType<T extends GovernanceAggregateArgs> = {
      [P in keyof T & keyof AggregateGovernance]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateGovernance[P]>
    : Prisma.GetScalarType<T[P], AggregateGovernance[P]>
}
...
type GetGovernanceGroupByPayload<T extends GovernanceGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<GovernanceGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof GovernanceGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], GovernanceGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], GovernanceGroupByOutputType[P]>
      }
    >
  >
...
export type GovernanceCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<GovernanceFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface GovernanceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['Governance'], meta: { name: 'Governance' } }
  /**
   ...
   * })
  **/
  count<T extends GovernanceCountArgs>(
    args?: Prisma.Subset<T, GovernanceCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], GovernanceCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends GovernanceGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, GovernanceGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetGovernanceGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
