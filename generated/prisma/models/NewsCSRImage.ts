...
// @ts-nocheck 
/*
 * This file exports the `NewsCSRImage` model and its related types.
 *
...
export type GetNewsCSRImageAggregateType<T extends NewsCSRImageAggregateArgs> = {
      [P in keyof T & keyof AggregateNewsCSRImage]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNewsCSRImage[P]>
    : Prisma.GetScalarType<T[P], AggregateNewsCSRImage[P]>
}
...
type GetNewsCSRImageGroupByPayload<T extends NewsCSRImageGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<NewsCSRImageGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof NewsCSRImageGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], NewsCSRImageGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], NewsCSRImageGroupByOutputType[P]>
      }
    >
  >
...
export type NewsCSRImageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<NewsCSRImageFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NewsCSRImageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['NewsCSRImage'], meta: { name: 'NewsCSRImage' } }
  /**
   ...
   * })
  **/
  count<T extends NewsCSRImageCountArgs>(
    args?: Prisma.Subset<T, NewsCSRImageCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], NewsCSRImageCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends NewsCSRImageGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, NewsCSRImageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNewsCSRImageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
