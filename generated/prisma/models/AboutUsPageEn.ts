...
// @ts-nocheck 
/*
 * This file exports the `AboutUsPageEn` model and its related types.
 *
...
export type GetAboutUsPageEnAggregateType<T extends AboutUsPageEnAggregateArgs> = {
      [P in keyof T & keyof AggregateAboutUsPageEn]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateAboutUsPageEn[P]>
    : Prisma.GetScalarType<T[P], AggregateAboutUsPageEn[P]>
}
...
type GetAboutUsPageEnGroupByPayload<T extends AboutUsPageEnGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<AboutUsPageEnGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof AboutUsPageEnGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], AboutUsPageEnGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], AboutUsPageEnGroupByOutputType[P]>
      }
    >
  >
...
export type AboutUsPageEnCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<AboutUsPageEnFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface AboutUsPageEnDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['AboutUsPageEn'], meta: { name: 'AboutUsPageEn' } }
  /**
   ...
   * })
  **/
  count<T extends AboutUsPageEnCountArgs>(
    args?: Prisma.Subset<T, AboutUsPageEnCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], AboutUsPageEnCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends AboutUsPageEnGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, AboutUsPageEnGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAboutUsPageEnGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
