...
// @ts-nocheck 
/*
 * This file exports the `NewsPage` model and its related types.
 *
...
export type GetNewsPageAggregateType<T extends NewsPageAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNewsPage[P]>
    : Prisma.GetScalarType<T[P], AggregateNewsPage[P]>
}
...
type GetNewsPageGroupByPayload<T extends NewsPageGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<NewsPageGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof NewsPageGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], NewsPageGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], NewsPageGroupByOutputType[P]>
      }
    >
  >
...
export type NewsPageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface NewsPageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends NewsPageCountArgs>(
    args?: Prisma.Subset<T, NewsPageCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], NewsPageCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, NewsPageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNewsPageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
