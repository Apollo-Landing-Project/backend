...
// @ts-nocheck 
/*
 * This file exports the `NewsNewsEn` model and its related types.
 *
...
export type GetNewsNewsEnAggregateType<T extends NewsNewsEnAggregateArgs> = {
      [P in keyof T & keyof AggregateNewsNewsEn]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNewsNewsEn[P]>
    : Prisma.GetScalarType<T[P], AggregateNewsNewsEn[P]>
}
...
type GetNewsNewsEnGroupByPayload<T extends NewsNewsEnGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<NewsNewsEnGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof NewsNewsEnGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], NewsNewsEnGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], NewsNewsEnGroupByOutputType[P]>
      }
    >
  >
...
export type NewsNewsEnCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<NewsNewsEnFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NewsNewsEnDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['NewsNewsEn'], meta: { name: 'NewsNewsEn' } }
  /**
   ...
   * })
  **/
  count<T extends NewsNewsEnCountArgs>(
    args?: Prisma.Subset<T, NewsNewsEnCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], NewsNewsEnCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends NewsNewsEnGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, NewsNewsEnGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNewsNewsEnGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
