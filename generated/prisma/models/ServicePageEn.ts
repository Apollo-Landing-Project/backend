...
// @ts-nocheck 
/*
 * This file exports the `ServicePageEn` model and its related types.
 *
...
export type GetServicePageEnAggregateType<T extends ServicePageEnAggregateArgs> = {
      [P in keyof T & keyof AggregateServicePageEn]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateServicePageEn[P]>
    : Prisma.GetScalarType<T[P], AggregateServicePageEn[P]>
}
...
type GetServicePageEnGroupByPayload<T extends ServicePageEnGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ServicePageEnGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ServicePageEnGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ServicePageEnGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ServicePageEnGroupByOutputType[P]>
      }
    >
  >
...
export type ServicePageEnCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ServicePageEnFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ServicePageEnDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ServicePageEn'], meta: { name: 'ServicePageEn' } }
  /**
   ...
   * })
  **/
  count<T extends ServicePageEnCountArgs>(
    args?: Prisma.Subset<T, ServicePageEnCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ServicePageEnCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ServicePageEnGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ServicePageEnGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetServicePageEnGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
