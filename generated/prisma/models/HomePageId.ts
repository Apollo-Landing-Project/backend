...
// @ts-nocheck 
/*
 * This file exports the `HomePageId` model and its related types.
 *
...
export type GetHomePageIdAggregateType<T extends HomePageIdAggregateArgs> = {
      [P in keyof T & keyof AggregateHomePageId]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateHomePageId[P]>
    : Prisma.GetScalarType<T[P], AggregateHomePageId[P]>
}
...
type GetHomePageIdGroupByPayload<T extends HomePageIdGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<HomePageIdGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof HomePageIdGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], HomePageIdGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], HomePageIdGroupByOutputType[P]>
      }
    >
  >
...
export type HomePageIdCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<HomePageIdFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface HomePageIdDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['HomePageId'], meta: { name: 'HomePageId' } }
  /**
   ...
   * })
  **/
  count<T extends HomePageIdCountArgs>(
    args?: Prisma.Subset<T, HomePageIdCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], HomePageIdCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends HomePageIdGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, HomePageIdGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetHomePageIdGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
