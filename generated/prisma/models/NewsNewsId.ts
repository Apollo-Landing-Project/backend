...
// @ts-nocheck 
/*
 * This file exports the `NewsNewsId` model and its related types.
 *
...
export type GetNewsNewsIdAggregateType<T extends NewsNewsIdAggregateArgs> = {
      [P in keyof T & keyof AggregateNewsNewsId]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNewsNewsId[P]>
    : Prisma.GetScalarType<T[P], AggregateNewsNewsId[P]>
}
...
type GetNewsNewsIdGroupByPayload<T extends NewsNewsIdGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<NewsNewsIdGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof NewsNewsIdGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], NewsNewsIdGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], NewsNewsIdGroupByOutputType[P]>
      }
    >
  >
...
export type NewsNewsIdCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<NewsNewsIdFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NewsNewsIdDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['NewsNewsId'], meta: { name: 'NewsNewsId' } }
  /**
   ...
   * })
  **/
  count<T extends NewsNewsIdCountArgs>(
    args?: Prisma.Subset<T, NewsNewsIdCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], NewsNewsIdCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends NewsNewsIdGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, NewsNewsIdGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNewsNewsIdGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
