...
// @ts-nocheck 
/*
 * This file exports the `CarGalleryEn` model and its related types.
 *
...
export type GetCarGalleryEnAggregateType<T extends CarGalleryEnAggregateArgs> = {
      [P in keyof T & keyof AggregateCarGalleryEn]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCarGalleryEn[P]>
    : Prisma.GetScalarType<T[P], AggregateCarGalleryEn[P]>
}
...
type GetCarGalleryEnGroupByPayload<T extends CarGalleryEnGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CarGalleryEnGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CarGalleryEnGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CarGalleryEnGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CarGalleryEnGroupByOutputType[P]>
      }
    >
  >
...
export type CarGalleryEnCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CarGalleryEnFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CarGalleryEnDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CarGalleryEn'], meta: { name: 'CarGalleryEn' } }
  /**
   ...
   * })
  **/
  count<T extends CarGalleryEnCountArgs>(
    args?: Prisma.Subset<T, CarGalleryEnCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CarGalleryEnCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CarGalleryEnGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CarGalleryEnGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCarGalleryEnGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
