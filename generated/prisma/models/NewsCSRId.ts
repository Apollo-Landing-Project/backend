...
// @ts-nocheck 
/*
 * This file exports the `NewsCSRId` model and its related types.
 *
...
export type GetNewsCSRIdAggregateType<T extends NewsCSRIdAggregateArgs> = {
      [P in keyof T & keyof AggregateNewsCSRId]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNewsCSRId[P]>
    : Prisma.GetScalarType<T[P], AggregateNewsCSRId[P]>
}
...
type GetNewsCSRIdGroupByPayload<T extends NewsCSRIdGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<NewsCSRIdGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof NewsCSRIdGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], NewsCSRIdGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], NewsCSRIdGroupByOutputType[P]>
      }
    >
  >
...
export type NewsCSRIdCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<NewsCSRIdFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NewsCSRIdDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['NewsCSRId'], meta: { name: 'NewsCSRId' } }
  /**
   ...
   * })
  **/
  count<T extends NewsCSRIdCountArgs>(
    args?: Prisma.Subset<T, NewsCSRIdCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], NewsCSRIdCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends NewsCSRIdGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, NewsCSRIdGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNewsCSRIdGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
