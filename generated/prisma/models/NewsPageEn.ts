...
// @ts-nocheck 
/*
 * This file exports the `NewsPageEn` model and its related types.
 *
...
export type GetNewsPageEnAggregateType<T extends NewsPageEnAggregateArgs> = {
      [P in keyof T & keyof AggregateNewsPageEn]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNewsPageEn[P]>
    : Prisma.GetScalarType<T[P], AggregateNewsPageEn[P]>
}
...
type GetNewsPageEnGroupByPayload<T extends NewsPageEnGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<NewsPageEnGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof NewsPageEnGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], NewsPageEnGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], NewsPageEnGroupByOutputType[P]>
      }
    >
  >
...
export type NewsPageEnCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<NewsPageEnFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NewsPageEnDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['NewsPageEn'], meta: { name: 'NewsPageEn' } }
  /**
   ...
   * })
  **/
  count<T extends NewsPageEnCountArgs>(
    args?: Prisma.Subset<T, NewsPageEnCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], NewsPageEnCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends NewsPageEnGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, NewsPageEnGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNewsPageEnGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
