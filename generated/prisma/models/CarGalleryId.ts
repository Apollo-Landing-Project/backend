...
// @ts-nocheck 
/*
 * This file exports the `CarGalleryId` model and its related types.
 *
...
export type GetCarGalleryIdAggregateType<T extends CarGalleryIdAggregateArgs> = {
      [P in keyof T & keyof AggregateCarGalleryId]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCarGalleryId[P]>
    : Prisma.GetScalarType<T[P], AggregateCarGalleryId[P]>
}
...
type GetCarGalleryIdGroupByPayload<T extends CarGalleryIdGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CarGalleryIdGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CarGalleryIdGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CarGalleryIdGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CarGalleryIdGroupByOutputType[P]>
      }
    >
  >
...
export type CarGalleryIdCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CarGalleryIdFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CarGalleryIdDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CarGalleryId'], meta: { name: 'CarGalleryId' } }
  /**
   ...
   * })
  **/
  count<T extends CarGalleryIdCountArgs>(
    args?: Prisma.Subset<T, CarGalleryIdCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CarGalleryIdCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CarGalleryIdGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CarGalleryIdGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCarGalleryIdGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
