...
// @ts-nocheck 
/*
 * This file exports the `CompanyStructure` model and its related types.
 *
...
export type GetCompanyStructureAggregateType<T extends CompanyStructureAggregateArgs> = {
      [P in keyof T & keyof AggregateCompanyStructure]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCompanyStructure[P]>
    : Prisma.GetScalarType<T[P], AggregateCompanyStructure[P]>
}
...
type GetCompanyStructureGroupByPayload<T extends CompanyStructureGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CompanyStructureGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CompanyStructureGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CompanyStructureGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CompanyStructureGroupByOutputType[P]>
      }
    >
  >
...
export type CompanyStructureCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CompanyStructureFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CompanyStructureDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CompanyStructure'], meta: { name: 'CompanyStructure' } }
  /**
   ...
   * })
  **/
  count<T extends CompanyStructureCountArgs>(
    args?: Prisma.Subset<T, CompanyStructureCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CompanyStructureCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CompanyStructureGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CompanyStructureGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCompanyStructureGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
