...
// @ts-nocheck 
/*
 * This file exports the `NewsNews` model and its related types.
 *
...
export type GetNewsNewsAggregateType<T extends NewsNewsAggregateArgs> = {
      [P in keyof T & keyof AggregateNewsNews]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateNewsNews[P]>
    : Prisma.GetScalarType<T[P], AggregateNewsNews[P]>
}
...
type GetNewsNewsGroupByPayload<T extends NewsNewsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<NewsNewsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof NewsNewsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], NewsNewsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], NewsNewsGroupByOutputType[P]>
      }
    >
  >
...
export type NewsNewsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<NewsNewsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NewsNewsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['NewsNews'], meta: { name: 'NewsNews' } }
  /**
   ...
   * })
  **/
  count<T extends NewsNewsCountArgs>(
    args?: Prisma.Subset<T, NewsNewsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], NewsNewsCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, NewsNewsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNewsNewsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
