...
// @ts-nocheck 
/*
 * This file exports the `ServiceId` model and its related types.
 *
...
export type GetServiceIdAggregateType<T extends ServiceIdAggregateArgs> = {
      [P in keyof T & keyof AggregateServiceId]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateServiceId[P]>
    : Prisma.GetScalarType<T[P], AggregateServiceId[P]>
}
...
type GetServiceIdGroupByPayload<T extends ServiceIdGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ServiceIdGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ServiceIdGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ServiceIdGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ServiceIdGroupByOutputType[P]>
      }
    >
  >
...
export type ServiceIdCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ServiceIdFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ServiceIdDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ServiceId'], meta: { name: 'ServiceId' } }
  /**
   ...
   * })
  **/
  count<T extends ServiceIdCountArgs>(
    args?: Prisma.Subset<T, ServiceIdCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ServiceIdCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ServiceIdGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ServiceIdGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetServiceIdGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
